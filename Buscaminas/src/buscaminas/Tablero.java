...
public class Tablero {
     ...
     * @param nFilas Numero de Filas que tendra el Tablero
     * @param nColumnas Numero de Columnas que tendra el Tablero 
     */
    public Tablero(int nFilas, int nColumnas) {
        this.numFilas = nFilas;
        this.numColumnas = nColumnas;
        this.numMinas = 0;
        this.tabla = new Casilla[nFilas][nColumnas];
    ...
    public void insertarMinas(int numMinas){
        int fila, columna, contadorMinas = 0;
        ...
        for (int i = 0; i < numMinas; i++) {
            ...
            fila = (int) (Math.random() * getNumFilas());
            columna = (int) (Math.random() * getNumColumnas());
     ...
     */
    public Casilla geCasilla(int filas, int columnas){
